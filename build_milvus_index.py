...
class EnterpriseSecureRAG:
    ...
    def _setup_collection(self):
        ...
        if utility.has_collection(self.collection_name):
            ...
            fields = [
                ...
                FieldSchema(name="department", dtype=DataType.ARRAY, element_type=DataType.VARCHAR, 
                            max_capacity=50, max_length=100),
                FieldSchema(name="project_id", dtype=DataType.VARCHAR, max_length=100),
                # 修正：同上
                FieldSchema(name="role_access", dtype=DataType.ARRAY, element_type=DataType.VARCHAR, 
                            max_capacity=50, max_length=100),
    ...
    def secure_search(self, query: str, user_context: Dict, semantic_filters: Dict = None):
        """执行带权限卡控的向量检索"""
